...
<html lang="cs-cz">
  ...
  <body>
    ...
    <article>
      ...
      <section>
        <h2>Vítejte!</h2>
        <p>Vítejte v systému, <?= htmlspecialchars($_SESSION['uzivatel_id']) ?></p>
        <?php
          if(!$_SESSION['uzivatel_ucitel'])
            echo('<p>Jste přihlášen jako student</p>');
          else
            echo('<p>Jste přihlášen jako učitel</p>');
        ?>
      </section>
